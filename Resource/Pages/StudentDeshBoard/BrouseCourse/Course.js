            ...
            <View style={{ height: heightToDp('35'), backgroundColor: 'rgb(255,217,84)' }}>
                <View style={{ marginStart: widthToDp('4'), marginTop: heightToDp('2') }}>
                    ...
                    <View style={{ marginTop: heightToDp('2') }}>
                        <Text style={{ color: '#000', fontSize: widthToDp('5.5'), fontWeight: 'bold' }}>Explore Course</Text>
                    </View>
                    <View style={{ marginTop: heightToDp('2') }}>
                        <Text style={{ color: '#000', fontSize: widthToDp('4') }}>Explore Course from all the boards and mediums{'\n'}on GRKVC </Text>
                    </View>
                ...
                <ScrollView>
                    <View>
                        ...
                        >
                            <View style={{ flexDirection: 'row', marginEnd: widthToDp('2'), marginStart: widthToDp('2') }}>
                                <View style={{ width: widthToDp('25'), marginTop: heightToDp('2'), height: heightToDp('6'), borderRadius: widthToDp('4'), backgroundColor: 'rgb(1,70,148)', justifyContent: 'center', alignItems: 'center' }}>
                                    <Text style={{ color: '#fff', fontSize: widthToDp('5') }}>Course</Text>
                                </View>
                            </View>
                        </ScrollView>
                    </View>
                    <View>
                        <View style={{ marginTop: heightToDp('2'), marginStart: widthToDp('3') }}>
                            <Text style={{ color: '#000', fontWeight: 'bold', fontSize: widthToDp('5') }}>CBSE Training</Text>
                        </View>
                        <View style={{ alignItems: 'center', marginTop: heightToDp('2') }}>
                            <View style={{ width: widthToDp('95'), height: heightToDp('30'), borderRadius: widthToDp('5'), backgroundColor: '#fff' }}>
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <View>
                                        <View style={{ borderWidth: 1, marginTop: heightToDp('3'), width: widthToDp('20'), height: heightToDp('3.5'), backgroundColor: '#000', justifyContent: 'center', alignItems: 'center' }}>
                                            <Text style={{ color: '#fff' }}>Course</Text>
                                        </View>
                                        <View style={{ marginStart: widthToDp('4') }}>
                                            <View style={{ marginTop: heightToDp('1') }}>
                                                <Text style={{ color: '#000', fontSize: widthToDp('4.5'), fontWeight: 'bold' }}>Competency-based{'\n'}Education-Module 4</Text>
                                            </View>
                                            <View style={{ marginTop: heightToDp('2') }}>
                                                <Text style={{ color: '#000', fontSize: widthToDp('3.5') }}>Subject : English...+34</Text>
                                            </View>
                                            <View style={{ flexDirection: 'row', marginTop: heightToDp('1.5') }}>
                                                ...
                                                <View style={{ width: widthToDp('24'), height: heightToDp('4'), borderRadius: widthToDp('2'), justifyContent: 'center', alignItems: 'center', marginStart: widthToDp('3'), backgroundColor: 'rgb(250,233,251)' }}>
                                                    <Text style={{ fontSize: widthToDp('4'), color: 'rgb(152,121,215)' }}>English...+3</Text>
                                                </View>
                                                <View style={{ width: widthToDp('24'), height: heightToDp('4'), borderRadius: widthToDp('2'), justifyContent: 'center', alignItems: 'center', marginStart: widthToDp('3'), backgroundColor: 'rgb(226,239,247)' }}>
                                                    <Text style={{ fontSize: widthToDp('4'), color: 'rgb(128,141,149)' }}>Class 1...+11</Text>
                                                </View>
                                            </View>
