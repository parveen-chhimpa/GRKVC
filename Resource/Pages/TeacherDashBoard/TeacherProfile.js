...
export default function TeacherProfile(props) {
  return (
    ...
    <View style={{flexDirection:'row',alignItems:'center'}}>
      <View>
         <Text style={{fontWeight:'bold',color:'#000',fontSize:widthToDp('4')}}>Teacher</Text> 
      </View>
    ...
    <View style={{flexDirection:'row',alignItems:'center'}}>
      <View>
         <Text style={{fontWeight:'bold',color:'#000',fontSize:widthToDp('4')}}>State(Haryana)</Text> 
      </View>
      <View style={{marginStart:widthToDp('2')}}>
          <Feather name='edit' size={13} color={'rgb(116,155,224)'} />
      </View>
    ...
    <View style={{flexDirection:'row',alignItems:'center'}}>
      <View>
         <Text style={{fontWeight:'bold',color:'#000',fontSize:widthToDp('4')}}>Other</Text> 
      </View>
      <View style={{marginStart:widthToDp('2')}}>
          <Feather name='edit' size={13} color={'rgb(116,155,224)'} />
      </View>
